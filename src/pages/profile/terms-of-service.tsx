...
const termsofservice: NextPage = () => {
  return (
    <TermsOfUseAndPrivacyPolicyLayout>
      ...
      {/* 第1条（適用） */}
      <h1 className="mt-4 text-2xl font-bold">第1条（適用）</h1>
      <div className="mt-2">
      ...
      {/* 第2条（利用登録） */}
      <h1 className="mt-4 text-2xl font-bold">第2条（利用登録）</h1>
      <div className="mt-2">
        <p>
        ...
        <div className="mt-2">
          <p className="pl-4">1.利用登録の申請に際して虚偽の事項を届け出た場合 </p>
          <p className="pl-4">2.本規約に違反したことがある者からの申請である場合</p>
          <p className="pl-4">3.その他，当社が利用登録を相当でないと判断した場合</p>
        </div>
      </div>

      {/* 第3条（ユーザーIDおよびパスワードの管理） */}
      <h1 className="mt-4 text-2xl font-bold">第3条（ユーザーIDおよびパスワードの管理）</h1>
      <div className="mt-2">
      ...
      {/* 第5条（禁止事項） */}
      <h1 className="mt-4 text-2xl font-bold">第5条（禁止事項）</h1>
      <p className="mt-2">ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。</p>
      <div className="mt-2">
        ...
        <p>7.他のユーザーに成りすます行為</p>
        <p>8.当社のサービスに関連して，反社会的勢力に対して直接または間接に利益を供与する行為</p>
        <p>
          9.当社，本サービスの他のユーザーまたは第三者の知的財産権，肖像権，プライバシー，名誉その他の権利または利益を侵害する行為
        </p>
        <p>10.以下の表現を含み，または含むと当社が判断する内容を本サービス上に投稿し，または送信する行為</p>
        <div className="mt-2">
          <p className="pl-4">1.過度に暴力的な表現</p>
          <p className="pl-4">2.露骨な性的表現</p>
          <p className="pl-4">3.人種，国籍，信条，性別，社会的身分，門地等による差別につながる表現</p>
          <p className="pl-4">4.自殺，自傷行為，薬物乱用を誘引または助長する表現</p>
          <p className="pl-5">5.その他反社会的な内容を含み他人に不快感を与える表現</p>
        </div>

        <p>11.以下を目的とし，または目的とすると当社が判断する行為</p>
        <div className="mt-2">
          <p className="pl-4">1.営業，宣伝，広告，勧誘，その他営利を目的とする行為（当社の認めたものを除きます。）</p>
          <p className="pl-4">2.性行為やわいせつな行為を目的とする行為</p>
          <p className="pl-4">3.面識のない異性との出会いや交際を目的とする行為</p>
          <p className="pl-4">4.他のユーザーに対する嫌がらせや誹謗中傷を目的とする行為</p>
          <p className="pl-5">
            5.当社，本サービスの他のユーザー，または第三者に不利益，損害または不快感を与えることを目的とする行為
          </p>
          <p className="pl-5">6.その他本サービスが予定している利用目的と異なる目的で本サービスを利用する行為</p>
        </div>

        <p>12.宗教活動または宗教団体への勧誘行為</p>

        <p>13.その他，当社が不適切と判断する行為</p>
      </div>

      {/* 第6条（本サービスの提供の停止等） */}
      <h1 className="mt-4 text-2xl font-bold">第6条（本サービスの提供の停止等）</h1>
      <div className="mt-2">
        <p>
          1.当社は，以下のいずれかの事由があると判断した場合，ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。
        </p>
        <div className="mt-2">
          <p className="pl-4">1.本サービスにかかるコンピュータシステムの保守点検または更新を行う場合</p>
          <p className="pl-4">
            2.地震，落雷，火災，停電または天災などの不可抗力により，本サービスの提供が困難となった場合
          </p>
          <p className="pl-4">3.コンピュータまたは通信回線等が事故により停止した場合</p>
          <p className="pl-4">4.その他，当社が本サービスの提供が困難と判断した場合</p>
        </div>
      ...
      {/* 第7条（著作権） */}
      <h1 className="mt-4 text-2xl font-bold">第7条（著作権）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第8条（利用制限および登録抹消） */}
      <h1 className="mt-4 text-2xl font-bold">第8条（利用制限および登録抹消）</h1>
      <div className="mt-2">
        <p>
          1.当社は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，投稿データを削除し，ユーザーに対して本サービスの全部もしくは一部の利用を制限しまたはユーザーとしての登録を抹消することができるものとします。
        </p>
        <div className="mt-2">
          <p className="pl-4">1.本規約のいずれかの条項に違反した場合</p>
          <p className="pl-4">2.登録事項に虚偽の事実があることが判明した場合</p>
          <p className="pl-4">3.当社からの連絡に対し，一定期間返答がない場合</p>
          <p className="pl-4">4.本サービスについて，最終の利用から一定期間利用がない場合</p>
          <p className="pl-4">5.その他，当社が本サービスの利用を適当でないと判断した場合</p>
        </div>
        <p>
      ...
      {/* 第9条（退会） */}
      <h1 className="mt-4 text-2xl font-bold">第9条（退会）</h1>
      <div className="mt-2">
        <p>未実装</p>
      ...
      {/* 第10条（保証の否認および免責事項） */}
      <h1 className="mt-4 text-2xl font-bold">第10条（保証の否認および免責事項）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第11条（サービス内容の変更等） */}
      <h1 className="mt-4 text-2xl font-bold">第11条（サービス内容の変更等）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第12条（利用規約の変更） */}
      <h1 className="mt-4 text-2xl font-bold">第12条（利用規約の変更）</h1>
      <div className="mt-2">
        <p>1.当社は以下の場合には、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。</p>
        <div className="mt-2">
          <p className="pl-4">1.本規約の変更がユーザーの一般の利益に適合するとき。</p>
          <p className="pl-4">
            2.
      ...
      {/* 第13条（個人情報の取扱い） */}
      <h1 className="mt-4 text-2xl font-bold">第13条（個人情報の取扱い）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第14条（通知または連絡） */}
      <h1 className="mt-4 text-2xl font-bold">第14条（通知または連絡）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第15条（権利義務の譲渡の禁止） */}
      <h1 className="mt-4 text-2xl font-bold">第15条（権利義務の譲渡の禁止）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第16条（準拠法・裁判管轄） */}
      <h1 className="mt-4 text-2xl font-bold">第16条（準拠法・裁判管轄）</h1>
      <div className="mt-2">
