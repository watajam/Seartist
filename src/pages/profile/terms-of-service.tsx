...
const termsofservice: NextPage = () => {
  return (
    <TermsOfUseAndPrivacyPolicyLayout>
      ...
      {/* 第1条（適用） */}
      <h1 className="text-2xl font-bold mt-4">第1条（適用）</h1>
      <div className="mt-2">
      ...
      {/* 第2条（利用登録） */}
      <h1 className="text-2xl font-bold mt-4">第2条（利用登録）</h1>
      <div className="mt-2">
        <p>
      ...
      <h1 className="text-2xl font-bold mt-4">第3条（ユーザーIDおよびパスワードの管理）</h1>
      <div className="mt-2">
      ...
      {/* 第5条（禁止事項） */}
      <h1 className="text-2xl font-bold mt-4">第5条（禁止事項）</h1>
      ...
      {/* 第6条（本サービスの提供の停止等） */}
      <h1 className="text-2xl font-bold mt-4">第6条（本サービスの提供の停止等）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第7条（著作権） */}
      <h1 className="text-2xl font-bold mt-4">第7条（著作権）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第8条（利用制限および登録抹消） */}
      <h1 className="text-2xl font-bold mt-4">第8条（利用制限および登録抹消）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第9条（退会） */}
      <h1 className="text-2xl font-bold mt-4">第9条（退会）</h1>
      <div className="mt-2">
        <p>未実装</p>
      ...
      {/* 第10条（保証の否認および免責事項） */}
      <h1 className="text-2xl font-bold mt-4">第10条（保証の否認および免責事項）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第11条（サービス内容の変更等） */}
      <h1 className="text-2xl font-bold mt-4">第11条（サービス内容の変更等）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第12条（利用規約の変更） */}
      <h1 className="text-2xl font-bold mt-4">第12条（利用規約の変更）</h1>
      <div className="mt-2">
      ...
      {/* 第13条（個人情報の取扱い） */}
      <h1 className="text-2xl font-bold mt-4">第13条（個人情報の取扱い）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第14条（通知または連絡） */}
      <h1 className="text-2xl font-bold mt-4">第14条（通知または連絡）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第15条（権利義務の譲渡の禁止） */}
      <h1 className="text-2xl font-bold mt-4">第15条（権利義務の譲渡の禁止）</h1>
      <div className="mt-2">
        <p>
      ...
      {/* 第16条（準拠法・裁判管轄） */}
      <h1 className="text-2xl font-bold mt-4">第16条（準拠法・裁判管轄）</h1>
      <div className="mt-2">
