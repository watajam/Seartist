    ...
    <>
      ...
      >
        <div className="flex items-center justify-center min-h-screen">
          ...
          <div className="relative bg-white rounded  mx-auto   w-full ">
            <header className="px-4 py-3 text-4xl font-bold text-white bg-orange-300 flex justify-between fixed w-full  z-10">
              <button
            ...
            <ProfileEditingLayout>
              <Dialog.Title className="text-2xl font-bold text-center text-orange-300 ">
                プロフィール編集
              </Dialog.Title>
              <form onSubmit={handleSubmit(onSubmit)} className="mt-8">
                ...
                <Disclosure>
                  {({ open }) => (
                    <>
                      <Disclosure.Button
                        className="flex justify-between items-center w-full px-2 py-2 mt-8 text-base
                       text-white bg-orange-100 rounded-lg h-10  hover:bg-orange-200 focus:outline-none "
                      >
                        <span>ユーザー詳細の編集はこちら</span>
                        <AiFillCaretDown
                      ...
                      <Disclosure.Panel className=" pt-4 pb-2 text-sm text-gray-500">
                        ...
                        <div className="relative  mt-2">
                          ...
                          >
                            <option defaultValue="アーティスト">
                              アーティスト
                            </option>
                            <option defaultValue="イベント主催者">
                              イベント主催者
                            </option>
...
export default memo(ProfileEditingModal);
