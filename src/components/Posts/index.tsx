  ...
  return (
    <div className="grid gap-6 ">
      <div className="shadow rounded-2xl">
        <header className="bg-gray-400 text-white flex  p-4 rounded-t-2xl items-center font-bold text-2xl ">
        ...
        <div className="p-4">
          ...
          <div className="bg-orange-100 text-center h-48 mt-6">写真</div>
